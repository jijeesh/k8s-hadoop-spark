...
[jijeesh/docker-spark README](https://github.com/kubernetes-hadoop-spark/docker-spark)
...
```
docker run -it --rm jijeesh/spark-scala-template sbt console
```
...
```
FROM jijeesh/spark-scala-template:2.4.3-hadoop2.7
