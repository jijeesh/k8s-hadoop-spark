...
The Spark Python template image serves as a base image to build your own Python application to run on a Spark cluster. See [jijeesh/docker-spark README](https://github.com/kubernetes-hadoop-spark/docker-spark) for a description how to setup a Spark cluster.
...
#### Example Dockerfile
```
FROM jijeesh/spark-python-template:2.4.3-hadoop2.7
