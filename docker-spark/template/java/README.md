...
The Spark Java template image serves as a base image to build your own Java application to run on a Spark cluster. See [jijeesh/docker-spark README](https://github.com/kubernetes-hadoop-spark/docker-spark) for a description how to setup a Spark cluster.
...
#### Example Dockerfile
```
FROM jijeesh/spark-java-template:2.4.0-hadoop2.7
...
#### Example application
See [jijeesh/demo-spark-sensor-data](https://github.com/kubernetes-hadoop-spark/demo-spark-sensor-data).
